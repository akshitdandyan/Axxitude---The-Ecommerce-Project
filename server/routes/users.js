...
dotenv.config();
import {
    registerUser, getUser, seller_Account, getProductsFromSellers,
    sellerLogin, lauchSellerProduct, getLaunchedProducts, deleteLaunchedProduct,
    incClickOnProduct, addToCart, removeFromCart, updateAddress, buyItem, cancelOrder,
    postReview, sponserNewProduct, newFeedback, updateSellerData, addBankDetail
